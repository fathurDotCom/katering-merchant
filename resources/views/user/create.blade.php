            ...
            <div class="row g-5 g-xl-8">
                <div class="col-xl-12">
                    ...
                    <div class="card">
                        ...
                        <form id="form-input" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                            @csrf
