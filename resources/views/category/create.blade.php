                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title fs-3 fw-bold">
                                ...
                                <span class="text-muted mt-1 fw-semibold fs-7">Add New Category</span>
                            </div>
                        </div>
                        <form id="form-input" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('category.store') }}" method="POST" novalidate="novalidate">
                            @csrf
                            <div class="card-body p-9">
                                ...
                                <div class="row mb-8">
                                    ...
                                    <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="example category name">
                                        @error('name')
                                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
