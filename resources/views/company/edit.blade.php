                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">  
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            <div class="col-xl-3 text-center">
                                                ...
                                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('/assets/media/svg/avatars/blank.svg')">
                                                    <div class="image-input-wrapper w-125px h-125px bgi-position-center" style="background-size: 75%; background-image: url('{{ $data->logo_light ? '/uploads/companies/logos/'.$data->logo_light : '/assets/media/svg/brand-logos/volicity-9.svg' }}')"></div>
                                        ...
                                        <div class="row mb-8">
                                            ...
                                            <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="example company name" value="{{ $data->name }}">
                                                @error('name')
                                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-8">
                                            ...
                                            <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                <textarea class="form-control @error('address') is-invalid @enderror" name="address" cols="30" rows="3" placeholder="example address">{{ $data->address }}</textarea>
                                                @error('address')
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="row mb-8">
                                            ...
                                            <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                <input type="text" class="form-control @error('url') is-invalid @enderror" name="url" placeholder="http://example.url.com/" value="{{ $data->url }}">
                                                @error('url')
                                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-8">
                                            ...
                                            <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                <input type="text" class="form-control @error('facebook') is-invalid @enderror" name="facebook" placeholder="example url facebook" value="{{ $data->facebook }}">
                                                @error('facebook')
                                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-8">
                                            ...
                                            <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                <input type="text" class="form-control @error('instagram') is-invalid @enderror" name="instagram" placeholder="example url instagram" value="{{ $data->instagram }}">
                                                @error('instagram')
                                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-8">
                                            ...
                                            <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                <input type="text" class="form-control @error('youtube') is-invalid @enderror" name="youtube" placeholder="example url youtube" value="{{ $data->youtube }}">
                                                @error('youtube')
                                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row mb-8">
                                            ...
                                            <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                <input type="text" class="form-control @error('twitter') is-invalid @enderror" name="twitter" placeholder="example url twitter" value="{{ $data->twitter }}">
                                                @error('twitter')
                                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
